...
describe('CollectionPathHelper', () => {
    ...
    describe('-> set', () => {
        ...
        it('should set a specific path on object (mode: "lodash")', async () => {
        ...
        it('should set a specific path on array (mode: "lodash")', async () => {
        ...
        it('should create a simple path (mode: "lodash")', async () => {
